...

{
  ...
  emoji: "💻",
  tagline: "Build scalable software systems from programming fundamentals to production engineering.",
  levels: [
    {
      level: "Beginner",
      weeks: "Weeks 1–5",
      topics: [
        {
          ...
          summary: "Master programming fundamentals using Python.",
          covers: [
            "Python syntax",
          ...
          goal: "Write clean Python programs and solve beginner coding problems."
        },
        {
          icon: "🗄️",
          name: "SQL & Database Fundamentals",
          summary: "Learn relational databases and SQL queries.",
          covers: [
            "DBMS vs RDBMS",
          ...
          goal: "Design databases and retrieve data efficiently using SQL."
        },
        {
          icon: "🌿",
          name: "Git & GitHub",
          ...
          goal: "Manage projects and collaborate with teams using Git."
        }
      ]
    },
      ...
      topics: [
        {
          ...
          summary: "Build server-side applications and APIs.",
          covers: [
            "REST APIs",
            "HTTP Methods",
            "JSON",
          ...
          goal: "Develop secure backend services and APIs."
        },
        {
          icon: "🧩",
          name: "Data Structures & Algorithms",
          summary: "Master coding interview and software engineering concepts.",
          covers: [
            "Arrays",
            "Strings",
            "Linked Lists",
          ...
          goal: "Write optimized solutions for complex programming problems."
        },
        {
          icon: "🛢️",
          name: "Database Engineering",
          summary: "Design scalable database systems.",
          covers: [
            "Schema Design",
            "Relationships",
            "ORM",
          ...
          goal: "Design efficient, secure, and scalable databases."
        }
      ]
    },
      ...
      topics: [
        {
          icon: "🏗️",
          name: "System Design",
          summary: "Design scalable distributed software systems.",
          covers: [
            "Scalability",
            "Load Balancers",
            "Caching",
          ...
          goal: "Design production-ready software architectures."
        },
        {
          icon: "☁️",
          name: "Cloud & DevOps",
          summary: "Deploy applications to modern cloud platforms.",
          covers: [
            "AWS Basics",
            "EC2",
            "S3",
          ...
          goal: "Deploy scalable applications using cloud and DevOps tools."
        },
        {
          icon: "🚀",
          name: "Production Engineering",
          summary: "Prepare software for real-world deployment.",
          covers: [
            "Logging",
            "Monitoring",
            "Prometheus",
          ...
          goal: "Build reliable, monitored, and production-grade software."
        }
      ]
    }
  ]
